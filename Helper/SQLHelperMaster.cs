...
{
    public class SQLHelperMaster
    {
        SqlConnection con = new SqlConnection("Password=school@123;Persist Security Info=True;User ID=schoollogin;Initial Catalog=SchoolERP_Master_DB;Data Source=198.38.81.242,1232");
